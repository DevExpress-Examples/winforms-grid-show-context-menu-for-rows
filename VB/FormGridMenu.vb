...
Namespace RowsPopupMenu
    Partial Public Class FormGridMenu
        ...
        End Sub
        Private Sub ItemEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles MenuItem1.Click
            gridView1.ShowEditor()
        End Sub
        Private Sub ItemDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles MenuItem2.Click
